                        ...
                        <div class="row margin0 grey">
                                ...
                                <a href="<?php echo base_url()?>Products/ProductHSN"> <h5 class="card-header1">  View HSN </h5> </a>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <?php 
                                        $attributes = array('id' => '');
                                        echo form_open_multipart(base_url()."Products/edithsnCode/".$hsncode->producthsn_Id, $attributes);
                                        ?>
                                        <div class="form-group">
                                            <label for="producthsn_Code" class="col-form-label">Enter HSN Code</label>
                                            <input id="producthsn_Code" type="text" class="form-control" name="producthsn_Code" value="<?php echo $hsncode->producthsn_Code;?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="product_GST" type="text" class="form-control" name="product_GST" value="<?php echo $hsncode->product_GST;?>">
