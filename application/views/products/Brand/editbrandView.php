            ...
            <div class="container-fluid dashboard-content">
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Edit Brand - <?php echo $brand->brand_Name;?></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="row margin0 grey">
                                ...
                                <span class="table-title">Edit Brand</span>
...

    {
        ...
        echo "<div class='alert alert-success'>".$this->session->tempdata("upd_succ")."</div>";
                                        ...
                                        ?>
                                          <?php echo form_open_multipart(base_url()."Products/editBrand/".$brand->brand_Id);?>
                                            <div class="form-group">
                                                <label for="brand_Name" class="col-form-label">Enter Brand Name</label>
                                                <input id="brand_Name" type="text" class="form-control" name="brand_Name" placeholder="enter brand name" value="<?php echo $brand->brand_Name?>">
                                            ...
                                            <div class="form-group"> 
                                                ...
                                                <img src="<?php echo base_url()?>assets/images/brand/<?php echo $brand->brand_Logo?>" width="80">
                                            </div>
                                            <div class="form-group">
