                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="row margin0 grey">
                                ...
                                <a href="<?php echo base_url()?>Stock/skyzenproductStock"> <h5 class="card-header1">  View Product Stock  </h5> </a>
                                    ...
                                    <div class="card-body">
                                        <div class=""> 
                                <a href="<?php echo base_url()?>Stock/productStock" class="btn btn-info btn-lg">
                                                    <span class="glyphicon glyphicon-export"></span> Export
                                </a>
                                </div>
                                        <div class=''>
                                            <h3 id='updSuccess' style='display:none'>Successfully updated the stock</h3>
                                        </div>
                                        <div class="row">
                                        ...
                                        ?>
                                            ...
                                            <div class="form-group"> 
                                                <label for="brand_Logo" class="col-form-label">Product Stock</label>
                                                <input type="file" name="uploadFile" id="uploadFile" class="form-control" required>
                                            </div>
                                            <div class="form-group">
                                                <input type="submit" value="Submit" id="stocksubmit" name="stocksubmit" class="btn btn-rounded btn-primary">
                                            </div>
