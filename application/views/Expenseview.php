    ...
    <div class="nav-left-sidebar sidebarDark">
            <div class="menu-list">
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <li class="nav-item">
                            <a class="nav-link <?=($this->uri->segment(1)==='Expense')?'active':''?>" href="<?php echo base_url()?>Expense" ><i class="fa fa-fw fa-user-circle"></i> Expense</a>
                            </li>
                            
                            <li class="nav-item">
                            <a class="nav-link" href="#" ><i class="fa fa-fw fa-user-circle"></i> Categories</a>
                            </li>
                            
                            <li class="nav-item">
                            <a class="nav-link" href="#" ><i class="fa fa-fw fa-user-circle"></i> Posting</a>
                            </li>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Expenses Overview</h2>
                            ...
                            <div class="card">
                                <div class="card-body p-tb-20 text-center">
                                     ...
                                     <span style="font-size:20px;color:#333">4</span>
                                        <h4 style="padding-left: 0px;margin-right: -23px;margin-left: -30px;"> Expenses </h4>
                            ...
                            <div class="card">
                                <div class="card-body p-tb-20 text-center">
                                     ...
                                     <span style="font-size:20px;color:#333">3</span>
                                        <h4 style="margin-left: -16px;">Categories</h4>
                            ...
                            <div class="card">
                                <div class="card-body p-tb-20 text-center">
                                     ...
                                     <span style="font-size:20px;color:#333">6</span>
                                       <h4 style="margin-left: -16px;">Posting </h4>
