                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Sales Details </h2>
 ...
 <div class="row">
                ...
                <div class="row"> 
                    <div class="col-xs-12 col-sm-6 col-md-6"> 
                            ...
                            <h6> Voucher No : <?php echo $sale->Voucher_No;?> </h6>
                            <h6> Date : <?php echo $sale->Date;?> </h6>
                            <h6> Branch : <?php echo $sale->Branch;?> </h6>
                            <h6> Party : <?php echo $sale->Party;?> </h6>
                            <h6> Division : <?php echo $sale->Division;?> </h6>
