 ...
 <div class="row">
                ...
                <div class="row"> 
                    <div class="col-xs-12 col-sm-6 col-md-6"> 
                            ...
                            <h6> Voucher No : <?php echo $salesreturn->Voucher_No;?> </h6>
                            <h6> Date : <?php echo $salesreturn->salesreturn_Date;?> </h6>
                            <h6> Branch : <?php echo $salesreturn->Branch;?> </h6>
                            <h6> Party : <?php echo $salesreturn->Party;?> </h6>
                            <h6> Division : <?php echo $salesreturn->Division;?> </h6>
