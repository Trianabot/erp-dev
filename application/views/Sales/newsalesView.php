            ...
            <div class="container-fluid dashboard-content">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <div class="row">
                                ...
                                <?php echo form_open_multipart(base_url()."Sales/newcsvSales");?>
                                        ...
                                        <tbody>
                                          ...
                                          if($sales){
                                            foreach($sales as $sale){
                                                $voucher = trim($sale->Voucher_No);
                                                ?> 
                                                <tr> 
                                                    <td><?php echo $i;?></td>
                                                    <td><?php echo $sale->Date;?></td>
                                                    <td><?php echo $sale->Voucher_No;?></td>
                                                    <td><?php echo $sale->Party;?></td>
                                                    <td><?php echo $sale->Division;?></td>
                                                    <td>
                                                        <a href="<?php echo base_url()?>Sales/salesView/<?php echo $voucher;?>"> View </a>
                                                    </td>
                                                </tr>
                                                <?php
                                                $i++;
