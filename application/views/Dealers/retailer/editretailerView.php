                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="row margin0 grey">
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <span class="table-title">Edit Retailer</span>
                                <a href="<?php echo base_url()?>Dealers/retailer"> <h5 class="card-header1">  View Retailers </h5> </a>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row"> 
                                                ...
                                                <?php 
                                        $attributes = array('id' => '');
                                        echo form_open(base_url()."Dealers/editRetailer/".$retailer->retailer_Id, $attributes);?>
                                        ...
                                        <div class="row"> 
                                                <div class="col-xs-12 col-sm-12 col-md-12"> 
                                                    ...
                                                    <select name="dist_Name" class="progControlSelect2 form-control"> 
                                                        <option value="<?php echo $retailer->distributor_Id;?>"> <?php echo $retailer->comporganization_Name;?> </option>
                                                        <?php 
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-6"> 
                                                <div class="form-group">
                                                    ...
                                                    <input id="comporganization_Name" type="text" class="form-control" name="comporganization_Name" value="<?php echo $retailer->retailercompany_Name;?>">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-6"> 
                                                <div class="form-group"> 
                                                    ...
                                                    <input type="text" name="contact_Person" id="contact_Person" class="form-control"  value="<?php echo $retailer->retailercontact_Person;?>">
                                        ...
                                        <div class="row"> 
                                                <div class="col-xs-12 col-sm-6 col-md-6"> 
                                                        ...
                                                        <input type="text" name="retailer_Mobile" id="retailer_Mobile" class="form-control" value="<?php echo $retailer->retailer_Mobile;?>">
                                                    <span class="text-danger"> <?php echo form_error("retailer_Mobile");?></span>
                                                </div>
                                                <div class="col-xs-12 col-sm-6 col-md-6"> 
                                                        <label for="retailer_Email" class="col-form-label"> Email </label>
                                                        <input type="text" name="retailer_Email" id="retailer_Email" class="form-control" value="<?php echo $retailer->retailer_Email;?>">
                                        ...
                                        <div class="row"> 
                                                <div class="col-xs-12 col-sm-6 col-md-6"> 
                                                    ...
                                                    <select name="retailer_State" class="progControlSelect2 form-control"> 
                                                        <option value="<?php echo $retailer->retailerState_Id;?>"> <?php echo $retailer->state_Name;?> </option>
                                                        <?php 
                                                ...
                                                <div class="col-xs-12 col-sm-6 col-md-6"> 
                                                        ...
                                                        <select name="retailer_City" class="progControlSelect2 form-control"> 
                                                            <option value="<?php echo $retailer->retailerCity_Id;?>"><?php echo $retailer->city_Name;?></option>
                                                        </select>
                                                </div>
                                        </div>
                                        ...
                                        <div class="row"> 
                                                <div class="col-xs-12 col-sm-5 col-md-5"> 
                                                        ...
                                                        <textarea name="retailer_Address1" id="retailer_Address1" class="form-control"><?php echo $retailer->retailer_Address1;?></textarea>
                                                ...
                                                <div class="col-xs-12 col-sm-5 col-md-5"> 
                                                        ...
                                                        <textarea name="retailer_Address2" id="retailer_Address2" class="form-control"><?php echo $retailer->retailer_Address2;?></textarea>
                                                ...
                                                <div class="col-xs-12 col-sm-2 col-md-2"> 
                                                        ...
                                                        <input type="text" name="retailer_Pin" id="retailer_Pin" class="form-control" value="<?php echo $retailer->retailer_Pin;?>">
                                        ...
                                        <div class="row"> 
                                                <div class="col-xs-12 col-sm-6 col-md-6"> 
                                                        ...
                                                        <input type="text" name="retailer_GSTIN" id="retailer_GSTIN" class="form-control" value="<?php echo $retailer->retailer_GSTIN;?>">
                                                    <span class="text-danger"> <?php echo form_error("retailer_GSTIN");?></span>
                                                </div>
                                                <div class="col-xs-12 col-sm-6 col-md-6"> 
                                                        <label for="retailer_PAN" class="col-form-label"> PAN </label>
                                                        <input type="text" name="retailer_PAN" id="retailer_PAN" class="form-control" value="<?php echo $retailer->retailer_PAN;?>">
                                        ...
                                        <div class="row"> 
                                                <div class="col-xs-12 col-sm-4 col-md-4"> 
                                                        ...
                                                        <option value="<?php echo $retailer->retailer_Bank;?>"><?php echo $retailer->retailer_Bank;?></option>
                                                ...
                                                <div class="col-xs-12 col-sm-4 col-md-4"> 
                                                        ...
                                                        <input type="text" name="retailer_Account" id="retailer_Account" class="form-control" value="<?php echo $retailer->retailer_Account;?>">
                                                    <span class="text-danger"> <?php echo form_error("retailer_Account");?></span>
                                                </div>
                                                <div class="col-xs-12 col-sm-4 col-md-4"> 
                                                        <label for="retailer_IFSC" class="col-form-label"> IFSC </label>
                                                        <input type="text" name="retailer_IFSC" id="retailer_IFSC" class="form-control" value="<?php echo $retailer->retailer_IFSC;?>">
