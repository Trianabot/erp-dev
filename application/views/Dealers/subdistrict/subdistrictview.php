            ...
            <div class="menu-list">
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <a class="nav-link" href="<?php echo base_url()?>Dealers" ><i class="fa fa-fw fa-user-circle"></i> Overview </a>
                        ...
                        <li class="nav-item">
                                <a class="nav-link <?=($this->uri->segment(2)==='Subdistrict')?'active':''?>" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-2" aria-controls="submenu-2"><i class="fa fa-fw fa-rocket"></i> Location Settings </a>
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="<?php echo base_url()?>Dealers/Subdistrict" class="breadcrumb-link">Subdistrict</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Sub-Districts</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="row margin0 grey">
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <span class="table-title">Subdistrict Lists</span>
                                <a href="<?php echo base_url()?>Dealers/addsubDistrict"> <h5 class="card-header1">  Add Sub-District </h5> </a>
                                </div>
                            </div>
                                    ...
                                    <table class="table" id="brandTable">
                                        ...
                                        <tbody>
                                          ...
                                          foreach($subdistricts as $subdist) {
                                            ...
                                            <tr> 
                                                <td><?php echo $i;?></td>
                                                <td><?php echo $subdist->state_Name;?></td>
                                                <td><?php echo $subdist->dist_name;?></td>
                                                <td><?php echo $subdist->subdist_Name;?></td>
                                                <td>
                                                    <a href="<?php echo base_url()?>Dealers/editSubdistrct/<?php echo $subdist->subdist_Id;?>" class="editbtn">Edit</a>
                                                    <a href="<?php echo base_url()?>Dealers/deleteSubdistrct/<?php echo $subdist->subdist_Id;?>" class="deletebtn">Delete</a>
                                                </td>
                                            </tr>
                                            <?php
                                          }
