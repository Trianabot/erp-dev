...
<li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url()?>Dealers" ><i class="fa fa-fw fa-user-circle"></i> Overview </a>
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?=($this->uri->segment(2)==='editSubdistrct')?'active':''?>" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-2" aria-controls="submenu-2"><i class="fa fa-fw fa-rocket"></i> Location Settings </a>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="row margin0 grey">
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <span class="table-title">Edit Sub-District</span>
                                <a href="<?php echo base_url()?>Dealers/Subdistrict"> <h5 class="card-header1">  View Subdistrict </h5> </a>
                                    ...
                                    <div class="card-body">
                                        ...
                                        ?>
                                            <?php 
                                            $attributes = array('id' => '');
                                            echo form_open(base_url()."Dealers/editSubdistrct/".$subdist->subdist_Id, $attributes);?>
                                            <div class="form-group">
                                                <label for="state_Name" class="col-form-label">Select State Name</label>
                                                <select name="state_Name" class="form-control">
                                                    <option value="<?php echo $subdist->state_Id;?>"><?php echo $subdist->state_Name;?></option>
                                                        <?php
                                            ...
                                            <div class="form-group">
                                                ...
                                                <option value="<?php echo $subdist->dist_Id;?>"><?php echo $subdist->dist_name;?></option>
                                                        <?php
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="subdist_name" type="text" class="form-control" name="subdist_name" value="<?php echo $subdist->subdist_Name;?>">
