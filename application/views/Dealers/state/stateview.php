            ...
            <div class="menu-list">
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <a class="nav-link" href="<?php echo base_url()?>Dealers" ><i class="fa fa-fw fa-user-circle"></i> Overview </a>
                        ...
                        <li class="nav-item">
                                <a class="nav-link <?=($this->uri->segment(2)==='State')?'active':''?>" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-2" aria-controls="submenu-2"><i class="fa fa-fw fa-rocket"></i> Location Settings </a>
            ...
            <div class="container-fluid dashboard-content">
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="<?php echo base_url()?>Dealers/State" class="breadcrumb-link">States</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">State Lists</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="row margin0 grey">
                                ...
                                <span class="table-title">State Lists</span>
                                <a href="<?php echo base_url()?>Dealers/addState"> <h5 class="card-header1">  Add State </h5> </a>
                                </div>
                            </div>
                                        ...
                                        <tbody>
                                          ...
                                          foreach($states as $state) {
                                            ...
                                            <tr> 
                                                ...
                                                <td> 
                                                    <a href="<?php echo base_url()?>Dealers/editState/<?php echo $state->state_Id;?>" class="editbtn"> Edit </a>
                                                    <a href="<?php echo base_url()?>Dealers/deleteState/<?php echo $state->state_Id;?>" class="deletebtn"> Delete </a>
                                                </td>
                                            </tr>
                                            <?php
                                            $i++;
