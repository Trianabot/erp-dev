            ...
            <div class="menu-list">
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <a class="nav-link" href="<?php echo base_url()?>Dealers" ><i class="fa fa-fw fa-user-circle"></i> Overview </a>
                        ...
                        <li class="nav-item">
                                <a class="nav-link <?=($this->uri->segment(2)==='District')?'active':''?>" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-2" aria-controls="submenu-2"><i class="fa fa-fw fa-rocket"></i> Location Settings </a>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="row margin0 grey">
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <span class="table-title">District Lists</span>
                                <a href="<?php echo base_url()?>Dealers/addDistrict"> <h5 class="card-header1">  Add District </h5> </a>
                                </div>
                            </div>
                                    ...
                                    <table class="table" id="brandTable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr> 
                                                ...
                                                <td> 
                                                    <a href="<?php echo base_url()?>Dealers/editDistrict/<?php echo $dist->dist_Id;?>" class="editbtn"> Edit </a> 
                                                    <a href="<?php echo base_url()?>Dealers/deleteDistrict/<?php echo $dist->dist_Id;?>" class="deletebtn"> Delete </a>     
                                                </td>
                                            </tr>
                                            <?php
                                            $i++;
