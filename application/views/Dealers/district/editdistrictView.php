...
<li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url()?>Dealers" ><i class="fa fa-fw fa-user-circle"></i> Overview </a>
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?=($this->uri->segment(2)==='editDistrict')?'active':''?>" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-2" aria-controls="submenu-2"><i class="fa fa-fw fa-rocket"></i> Location Settings </a>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">District </h2>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="row margin0 grey">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                                <span class="card-header">Edit District</span>
                                <a href="<?php echo base_url()?>Dealers/District"> <h5 class="card-header1">  View Districts </h5> </a>
                                </div>
                                    <div class="card-body">
                                        ...
                                        ?>
                                            <?php 
                                            $attributes = array('id' => '');
                                            echo form_open(base_url()."Dealers/editDistrict/".$district->dist_Id, $attributes);?>
                                            <div class="form-group">
                                                <label for="state_Name" class="col-form-label">Select State Name</label>
                                                <select name="state_Name" class="form-control">
                                                    <option value="<?php echo $district->state_Id;?>"> <?php echo $district->state_Name;?> </option>
                                                        <?php
                                            ...
                                            <div class="form-group">
                                                <label for="dist_name" class="col-form-label"> District </label>
                                                <input id="dist_name" type="text" class="form-control" name="dist_name" value="<?php echo $district->dist_name;?>">
