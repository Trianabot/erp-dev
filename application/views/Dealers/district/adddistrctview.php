...
<li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url()?>Dealers" ><i class="fa fa-fw fa-user-circle"></i> Overview </a>
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?=($this->uri->segment(2)==='addDistrict')?'active':''?>" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-2" aria-controls="submenu-2"><i class="fa fa-fw fa-rocket"></i> Location Settings </a>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="row margin0 grey">
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <span class="table-title">Add District</span>
                                <a href="<?php echo base_url()?>Dealers/District"> <h5 class="card-header1">  View Districts </h5> </a>
                                    ...
                                    <div class="card-body">
                                        ...
                                        ?>
                                            <?php 
                                            $attributes = array('id' => '');
                                            echo form_open(base_url()."Dealers/addDistrict", $attributes);?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="dist_name" type="text" class="form-control" name="dist_name" placeholder="enter district name">
