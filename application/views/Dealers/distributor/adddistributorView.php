                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="row margin0 grey">
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <span class="table-title">New Distributor</span>
                                <a href="<?php echo base_url()?>Dealers/distributor"> <h5 class="card-header1">  View Distributors </h5> </a>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row"> 
                                                ...
                                                <?php 
                                        $attributes = array('id' => '');
                                        echo form_open(base_url()."Dealers/addDistributor", $attributes);?>
									 <div class="card">
                        <div class="row margin0 grey">
                            <div class="col-xs-12 col-sm-12 col-md-12">
										<div id="" class="m-t-10">
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-6"> 
											<div class="form-group">
                                                    ...
                                                    <input id="comporganization_Name" type="text" class="form-control" name="comporganization_Name" placeholder="enter company/organisation" value="<?php echo set_value("comporganization_Name");?>">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-6"> 
                                                <div class="form-group"> 
                                                    ...
                                                    <input type="none" name="contact_Person" id="contact_Person" class="form-control" placeholder="enter contact person" value="<?php echo set_value("contact_Person");?>">
                                                ...
                                                <div class="col-xs-12 col-sm-6 col-md-6"> 
                                                        ...
                                                        <input type="text" name="dist_Mobile" id="dist_Mobile" class="form-control" placeholder="enter mobile number" value="<?php echo set_value("dist_Mobile");?>">
                                                    <span class="text-danger"> <?php echo form_error("dist_Mobile");?></span>
                                                </div>
                                                <div class="col-xs-12 col-sm-6 col-md-6"> 
                                                        <label for="dist_Email" class="col-form-label"> Email </label>
                                                        <input type="text" name="dist_Email" id="dist_Email" class="form-control" placeholder="enter email" value="<?php echo set_value("dist_Email");?>">
									 ...
									 <div class="row margin0 grey">
                                        ...
                                        <div class="row"> 
                                                ...
                                                <div class="col-xs-12 col-sm-6 col-md-6"> 
                                                        ...
                                                        <textarea name="dist_Address1" id="dist_Address1" class="form-control" placeholder="Enter Address 1"></textarea>
                                                ...
                                                <div class="col-xs-12 col-sm-6 col-md-6"> 
                                                        ...
                                                        <textarea name="dist_Address2" id="dist_Address2" class="form-control" placeholder="Enter Address 2"></textarea>
                                                ...
                                                <div class="col-xs-12 col-sm-4 col-md-4"> 
                                                        ...
                                                        <select name="distcity_Name" class="form-control"> 
                                                            <option value=""> Select City </option>
                                                        </select>
                                                </div>
												<div class="col-xs-12 col-sm-4 col-md-4"> 
                                                        <label for="dist_Address2" class="col-form-label"> PIN Code  </label>
                                                        <input type="text" name="dist_Pincode" id="dist_Pincode" class="form-control" placeholder="pin code">
									 ...
									 <div class="row margin0 grey">
                                        ...
                                        <div class="row"> 
                                                ...
                                                <div class="col-xs-12 col-sm-4 col-md-4"> 
                                                        ...
                                                        <input type="text" name="dist_Account" id="dist_Account" class="form-control" placeholder="enter Bank Account No">
                                                    <span class="text-danger"> <?php echo form_error("dist_Account");?></span>
                                                </div>
                                                <div class="col-xs-12 col-sm-4 col-md-4"> 
                                                        <label for="dist_IFSC" class="col-form-label"> IFSC </label>
                                                        <input type="text" name="dist_IFSC" id="dist_IFSC" class="form-control" placeholder="enter IFSC">
								...
								<div class="row"> 
                                                <div class="col-xs-12 col-sm-6 col-md-6"> 
                                                        ...
                                                        <input type="text" name="dist_GSTIN" id="dist_GSTIN" class="form-control" placeholder="enter GSTIN">
                                                    <span class="text-danger"> <?php echo form_error("dist_GSTIN");?></span>
                                                </div>
                                                <div class="col-xs-12 col-sm-6 col-md-6"> 
                                                        <label for="dist_PAN" class="col-form-label"> PAN </label>
                                                        <input type="text" name="dist_PAN" id="dist_PAN" class="form-control" placeholder="enter PAN">
							...
							<div class="card">
								...
								<div class="row"> 
                                                <div class="col-xs-12 col-sm-4 col-md-4"> 
                                                        <label for="dist_Email" class="col-form-label"> Password </label>
                                                        <input type="text" name="dist_Password" id="dist_Password" class="form-control" placeholder="enter password" value="<?php echo set_value("dist_Password");?>">
                                        ...
                                        <div class="row"> 
                                                <div class="m-t-10 offset-md-4 col-md-2" style="center"> 
