...
<li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url()?>Dealers" ><i class="fa fa-fw fa-user-circle"></i> Overview </a>
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?=($this->uri->segment(2)==='addCity')?'active':''?>" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-2" aria-controls="submenu-2"><i class="fa fa-fw fa-rocket"></i> Location Settings </a>
            ...
            <div class="container-fluid dashboard-content">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="row margin0 grey">
                                ...
                                <span class="table-title">Add City</span>
                                <a href="<?php echo base_url()?>Dealers/City"> <h5 class="card-header1">  View Cities </h5> </a>
                                </div>
                                    <div class="card-body">
                                        ...
                                        ?>
                                            <?php 
                                            $attributes = array('id' => '');
                                            echo form_open(base_url()."Dealers/addCity", $attributes);?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="city_Name" type="text" class="form-control" name="city_Name" placeholder="enter city name">
