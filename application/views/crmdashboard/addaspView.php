                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <a class="nav-link" href="<?php echo base_url()?>Crm" ><i class="fa fa-fw fa-user-circle"></i> Overview </a>
                             ...
                             <li class="nav-item">
                                ...
                                <ul class="nav flex-column">
                                    <li class="nav-item">
                                         <a class="nav-link" href="<?php echo base_url()?>Crm/Asp" ><i class="fa fa-fw fa-user-circle"></i> ASP </a>
                                    </li>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="<?php echo base_url()?>Crm/Stockview" ><i class="fa fa-fw fa-user-circle"></i> Stock View </a>         
                                    </li>
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="nav flex-column">
                                    <li class="nav-item">
                                         <a class="nav-link" href="<?php echo base_url()?>Crm/raiseTicket" ><i class="fa fa-fw fa-user-circle"></i> Raise Ticket </a>
                                    </li>
                                    
                                    <li class="nav-item">
                                        <a class="nav-link" href="<?php echo base_url()?>Crm/ticketHistory" ><i class="fa fa-fw fa-user-circle"></i> Ticket History </a>         
                                    </li>
            ...
            <div class="container-fluid dashboard-content">
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Add ASP</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="row margin0 grey">
                                ...
                                <a href="<?php echo base_url()?>Crm_Dashboard/Asp"> <h5 class="card-header1">  View ASP Lists </h5> </a>
                                </div>
                                    <div class="card-body">
                                        ...
                                        ?>
                                            ...
                                            echo form_open_multipart(base_url()."Crm_Dashboard/newAsp", $attributes);?>
