...
<div class="dashboard-wrapper">
...

    {
        ...
        echo "<div class='alert alert-success'>".$this->session->tempdata("upd_succ")."</div>";
                                ...
                                <?php 
                                 $attributes = array('id' => '');
                                 echo form_open_multipart(base_url()."Crm_Dashboard/editticket/".$ticket->ticketgenerate_Id, $attributes);
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-6" style='border-right: 2px solid black'>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="cust_Mobile" type="text" name="cust_Mobile" data-parsley-trigger="change" placeholder="Enter Mobile" autocomplete="off" class="form-control" value="<?php echo $ticket->cust_Mobile;?>">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-6">
                                                ...
                                                <input id="cust_Altmobile" type="text" name="cust_Altmobile" data-parsley-trigger="change" placeholder="Enter Alternate Mobile" autocomplete="off" class="form-control" value="<?php echo $ticket->cust_Altmobile;?>">
                                            </div>
                                            </div>
                                        </div>  
                                         <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="cust_Name" type="text" name="cust_Name" data-parsley-trigger="change" placeholder="Enter Name" autocomplete="off" class="form-control" value="<?php echo $ticket->cust_Name;?>">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-6">
                                                ...
                                                <input id="cust_Email" type="text" name="cust_Email" data-parsley-trigger="change" placeholder="Enter Email" autocomplete="off" class="form-control" value="<?php echo $ticket->cust_Email;?>">
                                         ...
                                         <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="cust_Address1" name="cust_Address1" placeholder="Enter Address" autocomplete="off" class="form-control"><?php echo $ticket->cust_Address1;?></textarea>
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-6">
                                                ...
                                                <textarea id="cust_Address2" name="cust_Address2" placeholder="Enter Address" autocomplete="off" class="form-control"><?php echo $ticket->cust_Address2;?></textarea>
                                            </div>
                                            </div>
                                        </div>   
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-4 col-md-4">                                                
                                                <div class="form-group">
                                                   ...
                                                   <input id="cust_Town" type="text" name="cust_Town" data-parsley-trigger="change" placeholder="Enter Town" autocomplete="off" class="form-control" value="<?php echo $ticket->cust_Town;?>">
                                            ...
                                            <div class="col-xs-12 col-sm-4 col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input id="cust_State" type="text" name="cust_State" data-parsley-trigger="change" placeholder="Enter state" autocomplete="off" class="form-control" value="<?php echo $ticket->cust_State;?>">
                                                </div>
                                            </div>
                                             <div class="col-xs-12 col-sm-4 col-md-4">
                                                <div class="form-group">
                                                    <label for="cust_Pincode">Pin-Code:</label>
                                                    <input id="cust_Pincode" type="text" name="cust_Pincode" data-parsley-trigger="change" placeholder="Enter PinCode" autocomplete="off" class="form-control" value="<?php echo $ticket->cust_Pincode;?>">
                                                </div>
                                            </div>
                                        </div>         
                                    </div>
                                             ...
                                             <div class="col-xs-12 col-sm-4 col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select id="prod_Name" type="text" name="prod_Name" data-parsley-trigger="change" class="form-control">
                                                        <option value="<?php echo $ticket->prod_Name;?>"><?php echo $ticket->product_Name;?></option>
                                                        <?php 
                                        ...
                                        <div class="row">
                                         ...
                                         <div class="row">
                                            <div class="col-xs-12 col-sm-9 col-md-9">
                                                ...
                                                <div class="form-group">                                                   
                                                      <label class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" name="prod_Casetype" class="custom-control-input" value='Install' <?php if($ticket->prod_Casetype == "Install"){ echo "checked";}?>><span class="custom-control-label">Installation</span>
                                                    </label>
                                                    <label class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" name="prod_Casetype" class="custom-control-input" value='Complaint' <?php if($ticket->prod_Casetype == "Complaint"){ echo "checked";}?>><span class="custom-control-label">Complaint</span>
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-3 col-md-3">                                                
