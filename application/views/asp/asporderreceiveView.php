...
<div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    ...
                    <?php echo form_open_multipart(base_url()."Asp/asporderReceive/".$order->shipment_No);?>
...
<td><?php echo $order->delivered_Qty;?>
<input type='hidden' name='dispatched_Qty[]' value='<?php echo $order->delivered_Qty;?>'>
</td>
...
<td></td>
             ...
             ?>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <input type="submit" name='orderReceive' value="Order Process" class="btn btn-rounded btn-primary float-right orderReceive">
                                        </div>
                                    </div>
        ...
        <div id="ordermrModal" class="modal fade">  
      <div class="modal-dialog">  
           <div class="modal-content">  
                ...
                <div class="modal-body">  
                    <h3>Please enter Qty less than Dispatched Qty</h3>
                </div>  
