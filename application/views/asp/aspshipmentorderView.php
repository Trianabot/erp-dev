                                        ...
                                        <div class='col-xs-12 col-sm-6 col-md-6' style='border-right:1px solid black'>
                                                <div class='row'> 
                                                    ...
                                                    <div class='col-xs-12 col-sm-6 col-md-6'> 
                                                        ...
                                                        <div><?php echo $aspdetail->userdept_Name;?></div> <br> <br>
                                                        <div></div>
                                             ...
                                             <table class='table asporderTable'>
                                                <thead>
                                                    <tr style="border:1px solid black">
                                                        ...
                                                        <th rowspan="2" style="vertical-align : middle;text-align:center;border:1px solid black">Stock Qty</th>
                                                        <th rowspan="2" style="vertical-align : middle;text-align:center;border:1px solid black">Demand Qty</th>
                                                        <th rowspan="2" style="vertical-align : middle;text-align:center;border:1px solid black">List Price</th>
                                                        ...
                                                        <th colspan='2' rowspan="2" style="vertical-align : middle;text-align:center;border:1px solid black">Amount</th>
...
//                                                    print_r($asporderproducts); die; 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="4" style="text-align:right;border:1px solid black">Gross Amount</td>
