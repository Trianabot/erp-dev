...
<div class="dashboard-wrapper">
            <div class="container-fluid dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-body">
                                <a href="<?php echo base_url()?>Asp/ticketCSV" class="btn btn-info btn-lg">
                                ...
                                <table class="display nowrap" id="ticketTable" style="width:100%">
                                        <thead style="color:white">
                                            <tr>
                                               <th rowspan="2" style='background-color: #6d767f'>Action</th>
                                                ...
                                                <th colspan="2" style='background-color: #f9c002; text-align: center'>Service Engineer </th>
                                            ...
                                            <tr>
                                                ...
                                                <th style='background-color: #f9c002'>Action</th>
                                                   ...
                                                   <tr>
                                                       <td>
                                                        ...
                                                        if($ticket->status === 'Ticket Closed'){
                                                            ?> 
                                                             <a class="" onclick="return false" href="javascript:void(0)"><i class="fa fa-bars" aria-hidden="true" title="reassign asp"></i></a>
                                                            <a href="javscript:void(0)" onclick="return false;"><i class="far fa-edit" aria-hidden="true" title="edit"></i></a>
                                                           
                                                            <?php
                                                        }else {
                                                            ?> 
                                                             <a class="update_Asp" onclick="edit_Technician(<?php echo $ticket->ticketgenerate_Id;?>)" href="javascript:void(0)"><i class="fa fa-bars" aria-hidden="true" title="reassign technician"></i></a>
                                                            <a href="<?php echo base_url()?>Asp/editticket/<?php echo $ticket->ticket_Id;?>"><i class="far fa-edit" aria-hidden="true" title="edit"></i></a>
                                    ...
                                    $row = $query->row();
                                                       ...
                                                       <td><?php 
                                                            ...
                                                            echo $ticket->crm_Amount;
                                                       
                                                        ?></td>
                                                       <td><?php 
                                                          $resservice_Cost='';
            $query = $this->db->query("select * from asp_product_info_replace_info where ticket_id=$ticket->ticket_Id");
            if($query->num_rows()>0){
                $res = $query->row();
            ...
            if($ticket->amt_textbox){
                $postedAmt = $ticket->amt_textbox;
            }else {
                $postedAmt = 0;
            }
            //$res_Cost = $postedAmt;
                  ...
                  echo $res_Cost;
                                                       ...
                                                       <td>
                                                           <?php 
                                                            if($ticket->ticket_Closedate){
                                                                ?> 
                                                                <a href='<?php echo base_url()?>Asp/ticketView/<?php echo $ticket->ticket_Id; ?>' class="btn btn-primary btn-xs">Closed</a>
                                                                <?php
                                                            }else if(($ticket->status === 'Part Pending') && ($ticket->asp)){
                                                            ?> 
                                                           
                       <a href='<?php echo base_url()?>Asp/ticketView/<?php echo $ticket->ticket_Id;?>' class="btn btn-primary btn-xs">Part Pending</a>
<!--                                                            <input type="button" name="view" value="Close" id="<?php echo $ticket->ticket_Id; ?>" class="btn btn-primary btn-xs view_data" style='color:green'/>-->
                                                           
                                                            <?php
                                                        }else if($ticket->asp){
                                                            ?> 
                                                        
                      <a href='<?php echo base_url()?>Asp/ticketView/<?php echo $ticket->ticket_Id; ?>' class="btn btn-primary btn-xs">Assigned</a>
<!--    
                                                            <input type="button" name="view" value="Process" id="<?php echo $ticket->ticket_Id; ?>" class="btn btn-info btn-xs view_data" style=
                                                                   color:red/>
-->
                                                            ...
                                                            <?php
                                                                ...
                                                                ?> 
                                                                <a href='<?php echo base_url()?>Asp/ticketView/<?php echo $ticket->ticket_Id; ?>' class="btn btn-primary btn-xs">Inprogress</a>
                                                                <?php
                                                            }
                                                            ?>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    ...
                    <button type="button" type="submit" id="btn_update" onclick="saveTech()" class="btn btn-primary">Reassign Technician</button>
                  </div>
                </div>
              </div>
            </div>
