...
//                                                        echo "<pre>";
//                                                        print_r($orders); die; 
                                                       for($i=0; $i < count($dat['prodpart_Id']); $i++){
                                                            
                                                            $part_Id = $dat['prodpart_Id'][$i];
                                                            //print_r($part_Id);die;
                                        $query = $this->db->query("select * from skyzenpart_master where Part_Name='$part_Id'");
                                        $result = $query->row();
                                        ...
                                        //echo "<pre>";
                                        //print_r($unitRate);die;
                                                            ?> 
                                                            <tr style=''>
                                                        <td><?php echo $i+1;?></td>                                                        
                                                        <td><?php echo $dat['prodpart_Name'][$i]; ?></td>
                                                        
                                                        
                                                        <td><?php echo $dat['proddemand_Qty'][$i];?></td>
                                                        <td><?php echo $unitRate;?></td>
                                                        <td></td> 
                                                        <td></td>
                                                        <td></td>
                                                        <td></td>
                                                        <td><?php echo $dat['prodnet_Amount'][$i]; ?></td>
