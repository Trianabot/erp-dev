            ...
            <div class="container-fluid dashboard-content">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class=''>
                                 <a href='<?php echo base_url()?>Crm/ticketHistory'>    
                                 <button style="font-size:12px; float:right">Previous <i class="fa fa-arrow-left"></i></button>
                                 </a>   
                                    </div>
...

    {
        ...
        echo "<div class='alert alert-success'>".$this->session->tempdata("upd_succ")."</div>";
                                ...
                                <?php 
                                 ...
                                 echo form_open_multipart(base_url()."Crm/editticket/".$ticket->ticket_Id, $attributes);
                                            ...
                                            <div class="col-xs-12 col-sm-4 col-md-4">
                                                <div class="form-group">
                                                    <label for="prod_Category">Category:</label>
                                                     <select id="prodedit_Category" type="text" name="prod_Category" data-parsley-trigger="change" class="form-control">
                            ...
                            <option value='<?php echo $asp->id;?>'><?php echo $asp->userdept_Name;?></option>
                                ...
                                if($ticket->asp){
                                    $query=$this->db->query("select * from users where id=$ticket->asp");
                                    $res = $query->row();
                                    $deptName = $res->userdept_Name;
                                    
                                    $query1 = $this->db->query("select * from users where usersdept_Name='$deptName' AND user_role_id=8");
                                    $res1 = $query1->result();
                                    ...
                                    <div class='col-xs-12 col-sm-6 col-md-6'>
                                        <div class='form-group'>
                                            ...
                                            <select name='technician_Name' id='technician_Name' class='form-control'>
                                                ...
                                                foreach($res1 as $re){
                                                    ?> 
                                                    <option value='<?php echo $re->id;?>'><?php echo $re->contact_Person;?></option>
                                                    <?php 
                                                }
                                                ?>
                                            </select>
                    ...
                    <input type='text' name='barcode_Scan' id='barcode_Scan' class='form-control' value='<?php echo set_value("barcode_Scan");?>'>
                                ...
                                <div class='row'>
                                     ...
                                     <div class='col-xs-12 col-sm-4 col-md-4'>
                                        <div class='form-group'>
                                            ...
                                            <input type='text' name='complaint_overview' id='complaint_overview' class='form-control'>
                                ...
                                <div class='row'>
                                    ...
                                    <div class='col-xs-12 col-sm-6 col-md-6'>
                                        <div class='form-group'>
                                            <label class="col-form-label"> Repair Remarks: </label>
                            ...
                            <div class='row'>
                                    <div class='col-xs-12 col-sm-6 col-md-6'>
                                        <div class='form-group'>
                                            ...
                                            <div class="form-group">                                                   
                                          <label class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" name="prodwarranty_Casetype"  id="prodwarranty_Casetype" class="custom-control-input" value='Warranty'><span class="custom-control-label">Warranty</span>
                                        </label>
                                        <label class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" name="prodwarranty_Casetype" id="prodwarranty_Casetype" class="custom-control-input" value='Outofwarranty'><span class="custom-control-label">Out of Warranty</span>
                                        </label>
                            ...
                            <div class='productwithwarranty' style='display:none'>
                                <input type='hidden' id='aspId' value='<?php echo $ticket->asp;?>'>
                                ...
                                <div class='row'>
                                    ...
                                    <div class='col-xs-12 col-sm-3 col-md-3 partcostSec'>
                                        <div class='form-group'>
                                            <label>Part Cost</label>
                            <input type='text' name='partCost' id='partCost' class='form-control partCost'>
                                        </div>
                                    </div>
                                    
                                    <div class='col-xs-12 col-sm-3 col-md-3'>
                                         <div class='form-group'>
                                             <button name='asppartnotify' class='btn btn-info notifybtn' style='display:none;' >Notify</button>
                            ...
                            <div class='row'>
                                            ...
                                            <div class='form-group'>
                                            <label>Part Name</label>
                                                <select name='editpartName_two' id='editpartName_two' class='form-control'>
                                                    <option value='0'>Select Part Name</option>
                                                    <?php 
                                                    foreach($parts as $part){
                                                        ?> 
                                        ...
                                        <div class='form-group'>
                                            <label>Part Cost</label>
                            <input type='text' name='partCost' id='partCost' class='form-control partCost' readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class='col-xs-12 col-sm-2 col-md-2'>
                                        <div class='form-group'>
                                            ...
                                            <input type='text' name='partcostGST' id='partcostGST' class='form-control' value='5'>
                                        </div>
                                    </div>
                                     <div class='col-xs-12 col-sm-2 col-md-2'>
                                        <div class='form-group'>
                            ...
                            <div class='row'>
                                ...
                                <div class='row'>
                                    ...
                                    <div class="row" class='editticketSub'>
                                        <div class="col-xs-12 col-sm-12 col-md-12">
