                                    ...
                                    <div class='row'>
                                        <div class='col-xs-12 col-sm-6 col-md-6' style='border-right:1px solid black'>
                                                <div class='row'> 
                                                    ...
                                                    <div class='col-xs-12 col-sm-6 col-md-6'> 
                                                        <div><?php echo $asp_detail->userdept_Name;?></div> <br> <br>
                                        ...
                                        <div class='col-xs-12 col-sm-6 col-md-6'>
                                                ...
                                                <div class='row'>
                                                    ...
                                                    <div class='col-xs-12 col-sm-8 col-md-8'>
                                                        ...
                                                        <div><input type='hidden' name='voucher_Id' value=''></div>
                                                        <div>
...
--> 
                                    ...
                                    <div class='row' >
                                        ...
                                        <div class='col-xs-12 col-sm-4 col-md-4'>
                                            ...
                                            <div><?php echo $shipdetail->shipping_Via?></div>
                                        </div>
                                        <div class='col-xs-12 col-sm-4 col-md-4'>
                                            <div>Courier No</div>
                                            <div><?php echo $shipdetail->courier_No;?></div>
                                        </div>
                                        <div class='col-xs-12 col-sm-4 col-md-4'>
                                            <div>Additional Details</div>
                                           <div><?php echo $shipdetail->additional_Detail;?></div>
                                        </div>
                                    </div>
                                    </div>
                                    ...
                                    <div class='' style='border:1px solid black'>
                                        <div class='row'>
                                            <div class='col-xs-12 col-sm-6 col-md-6'>
                                                    ...
                                                    <div>LR Number</div>
                                                    <div><?php echo $courierdetail->lr_Number;?></div>
                                            </div>
                                            <div class='col-xs-12 col-sm-6 col-md-6'>
                                                    <div>Courier Invoice</div>
                        <img src='<?php echo base_url()?>assets/images/courierInvoice/<?php echo $courierdetail->courierinvoice_Image?>' style='width:50px;' class="zoom">
                                             ...
                                             <table class='table asporderTable'>
                                                <thead>
                                                    <tr style="border:1px solid black">
                                                        ...
                                                        <th rowspan="2" style="vertical-align : middle;text-align:center;border:1px solid black">Disptached Qty</th>
