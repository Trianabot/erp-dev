                        ...
                        <div class='col-xs-12 col-sm-12 col-md-12'>
                            <div class='card'>
                                <div class='card-body'>
                                    ...
                                    <?php echo form_open(base_url()."Crm/asporderbalReceive/".$mrdetail->mrvoucher_No);?>
...
--> 
                                    ...
                                    <div class='row' >
                                        ...
                                        <div class='col-xs-12 col-sm-4 col-md-4'>
                                            ...
                                            <input type='text' name='shipping_Via' class='form-control'>
                                        </div>
                                        <div class='col-xs-12 col-sm-4 col-md-4'>
                                        ...
                                        <div class='row'>
                                            <div class='col-xs-12 col-sm-6 col-md-6'>
                                                <div class='form-group'>
                                                    ...
                                                    <input type='text' name='lrNumber' id='lrNumber' class='form-control' value='<?php echo $mrdetail->lr_Number;?>'>
                                                </div>
                                            </div>
                                            <div class='col-xs-12 col-sm-6 col-md-6'>
                                                <div class='form-group'>
                                             ...
                                             <table class='table asporderTable'>
                                                ...
                                                <tbody>
                                                    ...
                                                    <input type='hidden' name='part_Name[]' value='<?php echo $order->Part_Name;?>'>
                                                            ...
                                                            <td><input type='text' name='matrecieve_Qty[]' class='form-control' value='<?php echo $order->materialreceive_Qty;?>'></td>
                                                            <td></td>
                                                            <td></td>
                                                            <td></td>
                                                            <td></td>
