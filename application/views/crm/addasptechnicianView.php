            ...
            <div class="container-fluid dashboard-content">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="row margin0 grey">
                                ...
                                <a href="<?php echo base_url()?>Crm/Asptechnician"> <h5 class="card-header1">  View ASP Technician  </h5> </a>
                                </div>
                                    <div class="card-body">
                                        ...
                                        ?>
                                            ...
                                            echo form_open_multipart(base_url()."Crm/newaspTechnican", $attributes);?>
