                                        ...
                                        <div class='col-xs-12 col-sm-6 col-md-6'>
                                                ...
                                                <div class='row'>
                                                    ...
                                                    <div class='col-xs-12 col-sm-8 col-md-8'>
                                                        ...
                                                        <div><?php echo $shipment->voucher_Id;?></div>
                                                        <div><?php echo $shipment->order_Id;?></div>
                                                        <div><?php echo $shipment->shipment_Id;?></div>
                                                    </div>
                                                </div>
                                             ...
                                             <table class='table asporderTable'>
                                                <thead>
                                                    <tr style="border:1px solid #ddd">
                                                        ...
                                                        <th rowspan="2" style="vertical-align : middle;text-align:center;border:1px solid #ddd">Disptached Qty</th>
                                                        ...
                                                        <th colspan='2' rowspan="2" style="vertical-align : middle;text-align:center;border:1px solid #ddd">Amount</th>
                                                ...
                                                <tbody>
                                                    <?php 
//                                                    echo "<pre>";
//                                                    print_r($asporderproducts); die; 
                                                    $i=1;
                                                    if($asporderproducts){
                                                     foreach($asporderproducts as $order){
                                                         ?> 
                                                        <tr>
                                                            <td><?php echo $i;?></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="4" style="text-align:right;border:1px solid #ddd">Gross Amount</td>
                                    ...
                                    <div class='' style='border: 1px solid #ddd;margin: 0px;'> 
                                    <div class='row'>
                                            <div class='col-xs-12 col-sm-12 col-md-12'>
                                    ...
                                    <div class='row' style='margin:0px'>
                                     ...
                                     <div class="row">
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <a href="javascript:clickaspprint()" style="font-size:20px;margin-top:10px;">  <button class="btn btn-rounded btn-primary float-right">Print</button> </a>
                                        </div>
                                    </div>
