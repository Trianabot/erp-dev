                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Washers History Edit </h2>
                    ...
                    <div class="card">
                          ...
                          <div class="content" id="content">
                                <div class="card-header p-4">
                                    ...
                                    <form action = "<?php echo base_url();?>Plant_Dashboard/washer_edit" method = "post">
                                    <div class="float-right"> <h3 class="mb-0"></h3>
                                    Date : <input type="date" name="date" value="<?php echo $washer_det->cur_date;?>">
                                    </div>
                                </div>
                                <div class="card-body" style="background-color: aliceblue;">
                                    <div class="row mb-4">
                                        <div class="col-sm-6">
                                            ...
                                            <select class="form-control" name="company_name" id="input-select">
                                                 <option value="<?php echo $washer_det->company_name;?>"><?php echo $washer_det->company_name;?></option>
                                            ...
                                            <select class="form-control" name="product_name" id="input-select">
                                                 <option value="<?php echo $washer_det->product;?>"><?php echo $washer_det->product;?></option>
                                            ...
                                            <div>Product Quantity : <input class="form-control" type="text" name="product_qty" value="<?php echo $washer_det->product_qty;?>">  </div>
                                            <div>Production Supervisor : 
                                          
                                            <select name="supervisor_name" class="form-control" id="input-select">
                                                <option value="<?php echo $washer_det->supervisor_name;?>"><?php echo $washer_det->supervisor_name;?></option>
                                 ...
                                 <?php 
                                    ...
                                    ?>
                                            ...
                                            <div>Quality Supervisor : 
                                           
                                             <select name="line_name" class="form-control" id="input-select">
                                                 <option value="<?php echo $washer_det->line_supervisor_name;?>"><?php echo $washer_det->line_supervisor_name;?></option>
                                        <option>Choose ..</option>
                                        <?php 
                                        ...
                                        <div class="col-sm-6">
                                            <div>Motor : 
                                             ...
                                             <select class="form-control" id="input-select" name="fan_name" >
                                                         <option value="<?php echo $washer_det->fan_or_motor_name;?>"><?php echo $washer_det->fan_or_motor_name;?></option> 
                                            ...
                                            <select class="form-control" id="input-select" name="pump_name" >
                                                 <option value="<?php echo $washer_det->pump_or_timer_name;?>"><?php echo $washer_det->pump_or_timer_name;?></option>
                                                         <option>Change Type</option>
                                                         <?php 
                                            ...
                                            <select class="form-control" id="input-select" name="auto_swing_name" >
                                                 <option value="<?php echo $washer_det->auto_swing_or_gear_name;?>"><?php echo $washer_det->auto_swing_or_gear_name;?></option>
                                                         <option>Choose</option>
                                                         <?php 
                                       ...
                                       <select class="form-control"  name="product_color" >
                                                 <option value="<?php echo $washer_det->product_color;?>"><?php echo $washer_det->product_color;?></option>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                               ...
                                               <div>Barcode Start : <input class="form-control" type="text" name="barcode_start" value="<?php echo $barcode_det->barcode_start;?>"> </div>
                                               <div>Barcode End : <input class="form-control" type="text" name="barcode_end" value="<?php echo $barcode_det->barcode_end;?>"> </div>
                                               <div>Actual Qty : <input class="form-control" type="text" name="actual_qty" value="<?php echo $barcode_det->actual_qty;?>"> </div>
                                                </div>
                                                <?php
                                                }else {
                                                    ?> 
                                                    <div>Actual Qty  : <input class="form-control" type="text" name="product_name" value=""> </div>
                                                    <div>Barcode Start  : <input class="form-control" type="text" name="product_name" value=""> </div>
                                                    <div>Barcode End  : <input class="form-control" type="text" name="product_name" value=""> </div>
                                                    <?php  
                                                }
                                              ?>
                                            </div>
                         ...
                         <input type="hidden" name="ptype" value="<?php echo $ptype="SKYZEN WASHERS";?>">
