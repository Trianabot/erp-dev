...
<li class="nav-item ">
                        ...
                        <li class="nav-item ">
                           ...
                           <li class="nav-item">
                             ...
                             <div id="submenu-4" class="<?=($this->uri->segment(2)==='coolerpdf')?'collapse':''?> submenu" style="">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Washer History </h2>
                    ...
                    <div class="card">
                          ...
                          <div class="content" id="content">
                                <div class="card-header p-4">
                                     <a class="pt-2 d-inline-block" href="index.html">Washer Receipt</a>
                                   
                                    <div class="float-right"> <h3 class="mb-0"></h3>
                                    <?php echo $washer_det->cur_date;?></div>
                                </div>
                                <div class="card-body">
                                    <div class="row mb-4">
                                        <div class="col-sm-6">
                                            <div>Brand Name : <?php echo $washer_det->company_name;?></div>
                                            <div>Product Name : <?php echo $washer_det->product;?></div>
                                            <div>Product Quantity : <?php echo $washer_det->product_qty;?> </div>
                                            <div>Production Supervisor : <?php echo $washer_det->supervisor_name;?> </div>
                                            <div>Quality Supervisor : <?php echo $washer_det->line_supervisor_name;?></div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div>Motor : <?php echo $washer_det->fan_or_motor_name;?> </div>
                                            <div>Timer : <?php echo $washer_det->pump_or_timer_name;?> </div>
                                            <div>Gear : <?php echo $washer_det->auto_swing_or_gear_name;?></div>
                                             <div>Color : <?php echo ucfirst($washer_det->product_color);?></div>
                                        </div>
                                    ...
                                    <div class="row">
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                ...
                                                if($barcode_det){
                                                ?> 
                                                <div style="margin-top:-25px;"> BARCODE SERIES - <?php echo $barcode_det->barcode_start;?> - <?php echo $barcode_det->barcode_end;?>
                                                </div>
                                                <?php
                                                }else {
                                                    ?> 
                                                    <div style="margin-top:-25px;"> No Bar Code Assigned </div> <?php  
                                                }
                                              ?>
                                            </div>
                                        </div>
                                    <div class="table-responsive-sm m-t-10">
                                        <table class="table table-striped">
                                            ...
                                            <tbody>                                                
                                                <?php 
                                                if($critical_areas){
                                                    foreach($critical_areas as $area){
                                                        ?> 
                                                        <tr>
                                                        <td> <?php echo $area->ca_name;?></td>
                                                        <td> <?php echo $area->man_name;?></td>
                                                        </tr>
                                                        <?php
                                                    }
                                                }
