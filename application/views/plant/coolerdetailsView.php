...
<li class="nav-item ">
                        ...
                        <li class="nav-item ">
                           ...
                           <li class="nav-item">
                             ...
                             <div id="submenu-4" class="<?=($this->uri->segment(2)==='washerDetails')?'collapse':''?> submenu" style="">
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Cooler Hisotry</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                                    ...
                                    <table class="table" id="brandTable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col">Manpower Quantity</th>
                                                <th scope="col">Actual Quantity</th>
                                                <th scope="col">Barcode Start</th>
                                                <th scope="col">Barcode End</th>
                                         ...
                                         $i=0;
                                          foreach($coolers as $cooler){
                                             ...
                                             <tr> 
                                                 ...
                                                 <td> <?php echo $cooler->cur_date;?></td>
                                                  <td> <?php echo $cooler->company_name;?></td>
                                                 <td> <?php echo $cooler->product;?></td>
                                                 <td> <?php echo $cooler->product_color;?></td>
                                                  <td> <?php echo $cooler->product_qty;?></td>
                                                 <td> <?php echo $cooler->supervisor_name;?></td>
                                                 <td> <?php echo $cooler->line_supervisor_name;?></td>
                                                 <td><?php echo $cooler->manpower_Qty;?></td>
                                                 ...
                                                 <!--<td></td>-->
                                                  ...
                                                  <td> <a href="<?php echo base_url()?>Plant_Dashboard/coolerpdf/<?php echo $cooler->id?>" class="btn btn-info btn-xs"> 
                                                  PDF</a> </td>
                                                  <td> <a href="<?php echo base_url()?>Plant_Dashboard/cooleredit/<?php echo $cooler->id?>" class="btn btn-info btn-xs" style="
...
"> 
                                                  ...
                                                  <td>
                                                  <a href="javascript:;" onclick="return isconfirm('<?php echo base_url()?>Plant_Dashboard/coolers/<?php echo $cooler->id;?>');" class="btn btn-info btn-xs" style="
