        ...
        <!-- ============================================================== -->
         <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg fixed-top">
                <a class="navbar-brand" href="<?php echo base_url()?>Plant_Dashboard"><img src="<?php echo base_url()?>assets/icon2/skyzen.png" alt="" style="width: 18%;"></a>
                        ...
                        <li class="nav-item dropdown nav-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">
                                <div class="nav-user-info" style="margin-top:32px;">
                                    <h5 class="mb-0 text-white nav-user-name">Plant Admin</h5>
                                </div>
