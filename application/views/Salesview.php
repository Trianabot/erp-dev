                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Retailer Overview</h2>
                            ...
                            <div class="card">
                                <div class="card-body p-tb-20 text-center">
                                     ...
                                     <span style="font-size:20px;color:#333">4</span>
                                        <h4 style="padding-left: 0px;margin-right: -23px;margin-left: -30px;"> Distributors </h4>
                            ...
                            <div class="card">
                                <div class="card-body p-tb-20 text-center">
                                     ...
                                     <span style="font-size:20px;color:#333">6</span>
                                       <h4 style="margin-left: -16px;">Customers </h4>
