...
$dataPoints4 = array();
       ...
       $querycount = $this->db->query("select * from ticket_generate");
                ...
                $queryone = $this->db->query("select count(asp_Name) as close_count,asp_Name from ticket_generate where `status`='Ticket Closed' group by `asp`");
                ...
                $querytwo = $this->db->query("select count(asp_Name) as count,asp_Name from ticket_generate where `status`!='Ticket Closed' group by `asp`");
                ...
                $querythree = $this->db->query("select sum(amt_textbox) as amt,sum(crm_Amount) as crmamt,asp_Name from ticket_generate  group by `asp_Name`");
                ...
                $queryfour = $this->db->query("select sum(crm_Amount) as crmamt,asp_Name from ticket_generate  group by `asp_Name`");
                ...
                foreach ($queryfive->result() as $row)
                {
	             ...
	             $crm_Amount = 0;
                $querysix = $this->db->query("select sum(crm_Amount) as total,asp_Name from ticket_generate  group by `asp_Name`");
            ...
            <div class="container-fluid dashboard-content">
                ...
                <div class="row">
                 ...
                 <div class="row">
                    ...
                    <form action="<?php echo site_url('Crm/aspname');?>" method="POST">
                     <div class='col-xs-12 col-sm-4 col-md-4'>
                          <select name='aspname' id='aspname' class='form-control' onchange="this.form.submit()">
