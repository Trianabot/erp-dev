                                ...
                                <a href="<?php echo base_url()?>Purchase/Suppliers"> <h5 class="card-header1">  View Suppliers </h5> </a>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row"> 
                                                ...
                                                <?php 
                                        $attributes = array('id' => '');
                                        echo form_open(base_url()."Purchase/addSupplier", $attributes);?>

                                        <div class="row"> 
                                        <div class="col-xs-12 col-sm-6 col-md-6"> 
                                                <div class="form-group">
                                                    <label for="supporg_Name" class="col-form-label">Company/Organisation</label>
                                                    <input id="supporg_Name" type="text" class="form-control" name="supporg_Name" placeholder="enter company/organisation" value="<?php echo set_value("supporg_Name");?>">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-6"> 
                                                <div class="form-group"> 
                                                    ...
                                                    <input type="text" name="suppcont_Person" id="suppcont_Person" class="form-control" placeholder="enter contact person" value="<?php echo set_value("suppcont_Person");?>">
                                        ...
                                        <div class="row"> 
                                                <div class="col-xs-12 col-sm-6 col-md-6"> 
                                                        ...
                                                        <input type="text" name="supp_Mobile" id="supp_Mobile" class="form-control" placeholder="enter mobile number" value="<?php echo set_value("supp_Mobile");?>">
                                                    <span class="text-danger"> <?php echo form_error("supp_Mobile");?></span>
                                                </div>
                                                <div class="col-xs-12 col-sm-6 col-md-6"> 
                                                        <label for="supp_Email" class="col-form-label"> Email </label>
                                                        <input type="text" name="supp_Email" id="supp_Email" class="form-control" placeholder="enter email" value="<?php echo set_value("supp_Email");?>">
                                        ...
                                        <div class="row"> 
                                                <div class="col-xs-12 col-sm-5 col-md-5"> 
                                                        ...
                                                        <textarea name="supp_Address1" id="supp_Address1" class="form-control" placeholder="Enter Address 1"></textarea>
                                                ...
                                                <div class="col-xs-12 col-sm-5 col-md-5"> 
                                                        ...
                                                        <textarea name="supp_Address2" id="supp_Address2" class="form-control" placeholder="Enter Address 2"></textarea>
                                                ...
                                                <div class="col-xs-12 col-sm-2 col-md-2"> 
                                                        ...
                                                        <input type="text" name="supp_Pincode" id="supp_Pincode" class="form-control" placeholder="pin code">
                                        ...
                                        <div class="row"> 
                                                <div class="col-xs-12 col-sm-6 col-md-6"> 
                                                        ...
                                                        <input type="text" name="supp_GSTIN" id="supp_GSTIN" class="form-control" placeholder="enter GSTIN">
                                                    <span class="text-danger"> <?php echo form_error("supp_GSTIN");?></span>
                                                </div>
                                                <div class="col-xs-12 col-sm-6 col-md-6"> 
                                                        <label for="supp_PAN" class="col-form-label"> PAN </label>
                                                        <input type="text" name="supp_PAN" id="supp_PAN" class="form-control" placeholder="enter PAN">
                                        ...
                                        <div class="row"> 
                                                ...
                                                <div class="col-xs-12 col-sm-4 col-md-4"> 
                                                        ...
                                                        <input type="text" name="supp_Account" id="supp_Account" class="form-control" placeholder="enter Bank Account No">
                                                    <span class="text-danger"> <?php echo form_error("supp_Account");?></span>
                                                </div>
                                                <div class="col-xs-12 col-sm-4 col-md-4"> 
                                                        <label for="supp_IFSC" class="col-form-label"> IFSC </label>
                                                        <input type="text" name="supp_IFSC" id="supp_IFSC" class="form-control" placeholder="enter IFSC">
