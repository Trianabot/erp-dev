...
-->
        ...
        <li class="nav-item">
                    <a class="nav-link <?=($this->uri->segment(1)==='Products')?'active':''?>" href="<?php echo base_url()?>Asps/service_engineer" ><i class="fa fa-fw fa-user-circle"></i> Service Engineers</a>
                            ...
                            <li class="nav-item">
                    <a class="nav-link <?=($this->uri->segment(1)==='Products')?'active':''?>" href="" ><i class="fa fa-fw fa-user-circle"></i> Service Calls</a>
                            </li>
                            <li class="nav-item">
                    <a class="nav-link <?=($this->uri->segment(1)==='Products')?'active':''?>" href="" ><i class="fa fa-fw fa-user-circle"></i>Travel Expenses</a>
                            </li>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Service Overview </h2>
                            ...
                            <div class="card">
                                <div class="card-body p-tb-20 text-center">
                                     <div class="icon-circle-medium  icon-box-lg  bg-info-light">
                                        ...
                                        <h4 style="padding-left: 0px;margin-right: -23px;margin-left: -30px;"> ASPs </h4>
