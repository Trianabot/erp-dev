            ...
            <div class="container-fluid dashboard-content">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="row margin0 grey">
                                ...
                                <span class="table-title">Add Debit Note</span>
                                
                                <a href="<?php echo base_url()?>Setting/debitNotes"> <h5 class="card-header1">  View DebitNotes </h5> </a>
                                </div>
                                    <div class="card-body">
                                        ...
                                        ?>
                                            ...
                                            echo form_open_multipart(base_url()."Setting/newdebitNote", $attributes);?>
