            ...
            <div class="container-fluid dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Add Journal Entry</h2>
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Add Journal Entry</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="row margin0 grey">
                                ...
                                <span class="table-title">Add Journal Entry</span>
                                
                                <a href="<?php echo base_url()?>Setting/journalEntries"> <h5 class="card-header1">  View Journal Entries </h5> </a>
                                </div>
                                    <div class="card-body">
                                        ...
                                        ?>
                                            ...
                                            echo form_open_multipart(base_url()."Setting/newjournalEntry", $attributes);?>
