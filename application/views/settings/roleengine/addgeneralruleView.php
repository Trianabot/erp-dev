                            ...
                            <div class="card-body">
                                <div class='row'>
                                 ...
                                 <?php
                                        ...
                                        ?>
                                <?php echo form_open(base_url()."Setting/addgeneralRule");?>
...
<!--                             <td>
                             ...
                             <td>
                              ...
                              <td colspan="12" class="text-center show-butns" style="display:none">
                                 <button id="" type="button" class="btn btn-info btn-lg btn-round btn-pill-right waves-effect waves-classic btn-distorderadd aspallow_button">Add</button>
                            </td>
                            ...
                            <td colspan="12" class="text-center show-butns" style="display:none">
                                <button id="buttonClearItems" type="button" class="btn btn-danger btn-lg btn-round btn-pill-left waves-effect waves-classic aspallowclear_button">Clear</button>
                                        ...
                                        <tr>
                                                <td>
                                                    <input type="submit" value="Submit" class='btn btn-success generalsubmit_btn' name='generalrulesubmit' style='display:none'>
                                                </td>
                                            </tr>
                                    </table>
                                <?php echo form_close();?>
