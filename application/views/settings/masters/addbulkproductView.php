            ...
            <div class="container-fluid dashboard-content">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="row margin0 grey">
                                ...
                                <a href="<?php echo base_url()?>Setting/productMaster"> <h5 class="card-header1">  View Proudct Master  </h5> </a>
                                </div>
                            </div>
                                    <div class="card-body">
<div class=""> 
<!--                                     <a href="<?php echo base_url()?>Crm/aspCSV" class='btn btn-success'>Export CSV</a> -->
                                <a href="<?php echo base_url()?>Setting/productCSV" class="btn btn-info btn-lg">
                                        ...
                                        ?>
                                            ...
                                            echo form_open_multipart(base_url()."Setting/addbulkproductMaster", $attributes);?>
