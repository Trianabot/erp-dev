            ...
            <div class="container-fluid dashboard-content">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="row margin0 grey">
                                ...
                                <span class="table-title">Add Dealer</span>
                                
                                <a href="<?php echo base_url()?>Setting/dealers"> <h5 class="card-header1">  View Dealers </h5> </a>
                                </div>
                                    <div class="card-body">
                                        ...
                                        ?>
                                            ...
                                            echo form_open_multipart(base_url()."Setting/newDealers", $attributes);?>
