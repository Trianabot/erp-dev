            ...
            <div class="container-fluid dashboard-content">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="row margin0 grey">
                                ...
                                <span class="table-title">Add Parts</span>
                                
                                <a href="<?php echo base_url()?>Setting/partMaster"> <h5 class="card-header1">  View Parts Master  </h5> </a>
                                </div>
                            </div>
                            <div class=""> 
                                ...
                                <a href="<?php echo base_url()?>Setting/partCSV" class="btn btn-info btn-lg">
                                    ...
                                    <div class="card-body">
                                        ...
                                        ?>
                                            ...
                                            echo form_open_multipart(base_url()."Setting/addbulkpartMaster", $attributes);?>
