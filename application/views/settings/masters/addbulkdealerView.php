            ...
            <div class="container-fluid dashboard-content">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="row margin0 grey">
                                ...
                                <span class="table-title">Add Dealers</span>
                                
                                <a href="<?php echo base_url()?>Setting/dealersMaster"> <h5 class="card-header1">  View Dealers  </h5> </a>
                                </div>
                            </div>
                                    <div class="card-body">
                                            <div class=""> 
<!--                                     <a href="<?php echo base_url()?>Crm/aspCSV" class='btn btn-success'>Export CSV</a> -->
                                <a href="<?php echo base_url()?>Setting/dealerCSV" class="btn btn-info btn-lg">
                            ...
                            echo form_open_multipart(base_url()."Setting/addbulkdealerMaster", $attributes);?>
