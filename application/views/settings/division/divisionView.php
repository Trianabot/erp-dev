            ...
            <div class="container-fluid dashboard-content">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <div class="row">
                                ...
                                <?php echo form_open_multipart(base_url()."Setting/adddivisioncsv");?>
                                    ...
                                    <table class="table" id="example">
                                        ...
                                        <tbody>
                                          ...
                                          if($divisions){
                                            ...
                                            <tr> 
                                                <td> <?php echo $i;?> </td>
                                                <td> <?php echo $division->division_Code;?> </td>
                                                <td> <?php echo $division->division_Master;?>  </td>
                                                <td> <?php echo $division->division_MasterNode;?>  </td>
                                            </tr>    
                                               <?php
                                               $i++; 
                                            }
